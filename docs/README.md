...
[![Build Status](https://travis-ci.com/CN-weijialu/My-RPC-Framework.svg?branch=master)](https://travis-ci.com/CN-weijialu/My-RPC-Framework)
![GitHub](https://img.shields.io/github/license/CN-weijialu/My-RPC-Framework)
...
public class NettyTestClient {
    ...
    public static void main(String[] args) {
        ...
        String res = helloService.hello("jialu");
...
首先启动服务提供者，再启动消费者，在消费侧会输出`Hello, jialu`。
...
My-RPC-Framework is under the MIT license. See the [LICENSE](https://github.com/CN-weijialu/My-RPC-Framework/blob/master/LICENSE) file for details.